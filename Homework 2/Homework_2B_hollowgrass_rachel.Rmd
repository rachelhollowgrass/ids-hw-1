...
**Exercise 4:** Applying the same variable to multiple aesthetics results in theesthetics layered on top of each other, with the last aesthetic rendered on top of underlying layers.
