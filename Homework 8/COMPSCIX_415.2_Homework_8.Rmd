...
(b) Now, use the <code>performance()</code> function to calculate the area under the curve (AUC) for both ROC curves. Check <code>?performanc</code>e for help on plugging in the right <code>measure</code> argument.
